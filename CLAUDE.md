...
- MCP-тул `agent_message` сам проверяет локи и возвращает ошибку если агент занят
- Только координатор может форсировать отправку (`force=true`), предварительно вызвав `agent_kill`
