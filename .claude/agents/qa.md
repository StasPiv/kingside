...
**Если всё ОК:**
- Добавь комментарий: `QA: Задача проверена. <краткое описание что проверено>. @coordinator`
- НЕ переводи задачу в другой статус — закрытие выполняет только координатор

**Если есть проблемы:**
- Добавь комментарий: `QA: Задача не принята. <конкретное описание проблемы>. @coordinator`
