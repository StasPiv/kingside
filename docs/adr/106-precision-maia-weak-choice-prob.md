...
**Обновлено KS-4107 (2026-06-14): формула weak-set v2 — soft-threshold вместо ступеньки `loss_E > 0.02`. Подробности: см. ADR-125. `MAIA_WEAK_CHOICE_METRIC_VERSION` 1 → 2. Шаги 1–5 пп. 2.1 ниже остаются актуальны как описание шагов pipeline; поменялась только агрегация на шаге 6–7 (теперь непрерывный вес, не индикатор).**
Связано: ADR-066 (classify-WDL), ADR-104 (предшественник), ADR-125 (soft-threshold v2), KS-3380 (паттерн `searchmoves` + WDL).
