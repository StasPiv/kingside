...
3. **Продолжение линии (сужение вглубь).** От каждого первого хода играем ответы по **Maia top-1** (человечески вероятный) на каждом следующем полуходе. На двух заранее заданных глубинах (ply 2 и ply 4) допускаем развилку в 2 хода Maia — чтобы внутри плана были варианты. Ширина узла ≤ 2, вглубь сходится к 1 главной линии.
...
6. **Ограничение объёма:** не более 40 линий; если ветвление дало больше — отсечь по вероятности пути Maia (произведение вероятностей ходов линии).
