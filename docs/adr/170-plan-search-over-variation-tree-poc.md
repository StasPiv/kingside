...
**Дата:** 2026-07-26 (рев. 7 — §5.1: ограничение роста оракула (D_oracle=6, K_oracle=2, best-first), пределы обхода N_max/T_max/L_max с аварийной остановкой, периодический прогресс в лог — закрывают взрыв ветвления и слепоту построителя. См. рев. 6 — оракул Leela + Stockfish на листе, рев. 5 — ветвление по энтропии)
**Статус:** Предложено
