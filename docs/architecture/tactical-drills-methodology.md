...
### 2.3 Канонические инварианты предикатов (KS-2313)
...
- **Canonical answer rule** для всех 8 предикатов: strict-uniqueness — позиция с > 1 валидным ответом **отбрасывается**, никакого выбора среди многих. Это даёт большой % invalid в пилотных прогонах, но обеспечивает однозначность сравнения userAnswer против эталона.
