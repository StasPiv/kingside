...
![Автор: лента /lessons со своими и enrolled курсами](./screenshots/user-courses/lessons-list-author.png)
...
![Студент: /lessons без enrollment'а](./screenshots/user-courses/student-lessons-no-enrollment.png)
...
![Enrolled block desktop](./screenshots/user-courses/enrolled-block-desktop.png)
...
![Редактор: открытый text-шаг с WYSIWYG-toolbar](./screenshots/user-courses/editor-text-step-toolbar.png)
...
![Editor: тогл «Приватный» на demo-private-course](./screenshots/user-courses/editor-private-publish-toggle.png)
...
![Editor: StepTypePicker — три карточки типов](./screenshots/user-courses/editor-step-type-picker.png)
...
![Editor: модалка Set Position с табами FEN / Board Editor](./screenshots/user-courses/editor-board-modal.png)
...
![Editor: puzzle-step с фильтром mateIn1, limit 2](./screenshots/user-courses/editor-puzzle-step.png)
...
![Editor: endgame_drill-step](./screenshots/user-courses/editor-endgame-drill-step.png)
...
![Editor: DeleteCourseDialog](./screenshots/user-courses/editor-delete-course-dialog.png)
...
![Студент: страница публичного курса свежим взглядом](./screenshots/user-courses/student-fresh-course-view.png)
...
![Студент: смешанный урок (text + puzzle + endgame_drill) на старте](./screenshots/user-courses/student-mixed-lesson-pending.png)

После взаимодействия:

![Студент: смешанный урок — первый шаг auto-marked done (1/3 33%)](./screenshots/user-courses/student-mixed-lesson-progress.png)
...
![Студент: первый шаг урока 1 — стартовое состояние](./screenshots/user-courses/student-lesson-initial.png)

![Студент: после клика «Далее» — первый шаг done (50%)](./screenshots/user-courses/student-lesson-step-done.png)
...
![Студент: повторный заход на урок — stepsState восстановлен (2/2 100%)](./screenshots/user-courses/student-lesson-revisit.png)
...
![Студент: баннер «Курс пройден» на странице курса](./screenshots/user-courses/student-course-passed-banner.png)

В блоке `/lessons` → «Мои курсы» (для автора, прошедшего собственный
курс) — у карточки появляется бейдж «✓ ПРОЙДЕН» и компактные stats:

![Лента /lessons: карточка с бейджем «Пройден» и stats](./screenshots/user-courses/lessons-list-stats-and-passed.png)
...
![Студент: после addLesson баннер исчез, прогресс 2/3 уроков](./screenshots/user-courses/student-course-after-addlesson.png)
...
![Студент: empty-state пустого урока](./screenshots/user-courses/student-empty-lesson.png)
...
![Owner: страница курса со Statistics-блоком](./screenshots/user-courses/owner-course-stats.png)
...
![Owner: лента /lessons с stats-строкой под карточкой](./screenshots/user-courses/lessons-list-my-courses-section.png)
