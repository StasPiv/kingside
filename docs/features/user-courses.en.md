...
![Lessons page: a user with no courses of their own and no courses in progress](./screenshots/user-courses/student-lessons-no-enrollment.png)
...
![Lessons page: the "My courses" block with the author's cards](./screenshots/user-courses/lessons-list-my-courses-section.png)
...
![Lessons page: a card with the "Completed" badge and a counter of finishers](./screenshots/user-courses/lessons-list-stats-and-passed.png)
...
![Lessons page: the "Courses I'm taking" block (desktop)](./screenshots/user-courses/enrolled-block-desktop.png)

The same block on mobile:

![Lessons page: the "Courses I'm taking" block (mobile)](./screenshots/user-courses/enrolled-block-mobile.png)
...
![Lessons page: full view for an author with several courses](./screenshots/user-courses/lessons-list-author.png)

On mobile:

![Lessons page: the page on mobile](./screenshots/user-courses/lessons-list-mobile.png)
...
![Course editor: overview](./screenshots/user-courses/editor-overview.png)
...
![Editor: the publish toggle on a private course](./screenshots/user-courses/editor-private-publish-toggle.png)
...
![Editor: choosing the step type](./screenshots/user-courses/editor-step-type-picker.png)
...
![Editor: a text step with the formatting toolbar](./screenshots/user-courses/editor-text-step-toolbar.png)
...
![Editor: the "Set Position" modal with a visual board editor](./screenshots/user-courses/editor-board-modal.png)
...
- **By filter** — you set themes (for example "mateIn1", "pin",
  ...
  ![Editor: a puzzle step with a theme filter](./screenshots/user-courses/editor-puzzle-step.png)
...
![Editor: an endgame drill step with position and engine settings](./screenshots/user-courses/editor-endgame-drill-step.png)
...
![Editor: the delete-course confirmation dialog](./screenshots/user-courses/editor-delete-course-dialog.png)
...
![Student: opening someone's public course for the first time](./screenshots/user-courses/student-fresh-course-view.png)
...
![Lesson: first time opening, no steps are done](./screenshots/user-courses/student-lesson-initial.png)
...
![Lesson: the first step is marked done after clicking "Next"](./screenshots/user-courses/student-lesson-step-done.png)
...
![Lesson: all theory steps are marked done automatically](./screenshots/user-courses/student-lesson-auto-mark.png)
...
![Lesson: a puzzle step is open, the student needs to make a move](./screenshots/user-courses/student-puzzle-solving.png)
...
![Lesson: an endgame drill step is open, the student plays against the engine](./screenshots/user-courses/student-endgame-drill.png)
...
![Lesson: all steps are done, the "Complete lesson" button is active](./screenshots/user-courses/student-lesson-ready-to-complete.png)
...
![Lesson: opening it again — progress is restored](./screenshots/user-courses/student-lesson-revisit.png)
...
![Course: the "Course completed" banner after finishing all lessons](./screenshots/user-courses/student-course-passed-banner.png)
...
![Course: the banner is gone after the author added a new lesson](./screenshots/user-courses/student-course-after-addlesson.png)
...
![Lesson: the author hasn't added any steps — the lesson is empty](./screenshots/user-courses/student-empty-lesson.png)
...
![Author: the course page with the statistics block](./screenshots/user-courses/owner-course-stats.png)
