import {
  require_react_dom
} from "./chunk-GZDXEWST.js";
import {
  require_jsx_runtime
} from "./chunk-WVQZQMR2.js";
import {
  require_react
} from "./chunk-QVG3QQR7.js";
import {
  __publicField,
  __toESM
...
function getPositionUpdates(oldPosition, newPosition, noOfColumns, boardOrientation) {
  ...
  for (const newSquare in newPosition) {
    ...
    if (((_a = oldPosition[newSquare]) == null ? void 0 : _a.pieceType) === newPosition[newSquare].pieceType) {
      continue;
    }
    for (const oldSquare in oldPosition) {
      if (oldPosition[oldSquare].pieceType === newPosition[newSquare].pieceType && oldSquare !== newSquare && oldPosition[oldSquare].pieceType !== ((_b = newPosition[oldSquare]) == null ? void 0 : _b.pieceType)) {
    ...
    if (candidateSquares.length === 1) {
      ...
      for (const candidateSquare of candidateSquares) {
        ...
        const columnDifference = Math.abs(chessColumnToColumnIndex(((_c = candidateSquare.match(/^[a-z]+/)) == null ? void 0 : _c[0]) ?? "", noOfColumns, boardOrientation) - chessColumnToColumnIndex(((_d = newSquare.match(/^[a-z]+/)) == null ? void 0 : _d[0]) ?? "", noOfColumns, boardOrientation));
        const rowDifference = Math.abs(Number(((_e = candidateSquare.match(/\d+$/)) == null ? void 0 : _e[0]) ?? "") - Number(((_f = newSquare.match(/\d+$/)) == null ? void 0 : _f[0]) ?? ""));
        const isOldSquareLight = (chessColumnToColumnIndex(((_g = candidateSquare.match(/^[a-z]+/)) == null ? void 0 : _g[0]) ?? "", noOfColumns, boardOrientation) + Number(((_h = candidateSquare.match(/\d+$/)) == null ? void 0 : _h[0]) ?? "")) % 2 === 0;
        const isNewSquareLight = (chessColumnToColumnIndex(((_i = newSquare.match(/^[a-z]+/)) == null ? void 0 : _i[0]) ?? "", noOfColumns, boardOrientation) + Number(((_j = newSquare.match(/\d+$/)) == null ? void 0 : _j[0]) ?? "")) % 2 === 0;
        if (candidatePieceType === "P") {
          if (((_k = candidateSquare.match(/^[a-z]+/)) == null ? void 0 : _k[0]) === ((_l = newSquare.match(/^[a-z]+/)) == null ? void 0 : _l[0])) {
...
function getPromotionUpdates(oldPosition, newPosition, noOfRows, noOfColumns) {
  ...
  for (const newSquare in newPosition) {
    ...
    for (const oldSquare in oldPosition) {
      if (((_b = newPosition[oldSquare]) == null ? void 0 : _b.pieceType) === oldPosition[oldSquare].pieceType) {
        continue;
      }
...
function getRelativeCoords(boardOrientation, boardWidth, chessboardColumns, chessboardRows, square) {
  ...
  const x = chessColumnToColumnIndex(((_a = square.match(/^[a-z]+/)) == null ? void 0 : _a[0]) ?? "", chessboardColumns, boardOrientation) * squareWidth + squareWidth / 2;
  const y = chessRowToRowIndex(((_b = square.match(/\d+$/)) == null ? void 0 : _b[0]) ?? "", chessboardRows, boardOrientation) * squareWidth + squareWidth / 2;
  return { x, y };
}
...
var defaultPieces = {
  ...
  wR: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsxs)("g", { style: {
    opacity: "1",
    fill: (props == null ? void 0 : props.fill) ?? "#ffffff",
    fillOpacity: "1",
    fillRule: "evenodd",
  ...
  wN: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsxs)("g", { style: {
    opacity: "1",
    fill: "none",
    fillOpacity: "1",
    fillRule: "evenodd",
  ...
  wQ: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsxs)("g", { style: {
    fill: (props == null ? void 0 : props.fill) ?? "#ffffff",
    stroke: "#000000",
    strokeWidth: "1.5",
    strokeLinejoin: "round"
  ...
  wK: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsxs)("g", { style: {
    fill: "none",
    fillOpacity: "1",
    fillRule: "evenodd",
    stroke: "#000000",
  ...
  bP: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsx)("path", { d: "m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z", style: {
    opacity: "1",
    fill: (props == null ? void 0 : props.fill) ?? "#000000",
    fillOpacity: "1",
    fillRule: "nonzero",
    stroke: "#000000",
    strokeWidth: "1.5",
  ...
  bR: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsxs)("g", { style: {
    opacity: "1",
    fill: (props == null ? void 0 : props.fill) ?? "#000000",
    fillOpacity: "1",
    fillRule: "evenodd",
  ...
  bN: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsxs)("g", { style: {
    opacity: "1",
    fill: "none",
    fillOpacity: "1",
    fillRule: "evenodd",
    ...
    strokeDasharray: "none",
    strokeOpacity: "1"
  }, children: [(0, import_jsx_runtime.jsx)("path", { d: "M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18", style: { fill: (props == null ? void 0 : props.fill) ?? "#000000", stroke: "#000000" } }), (0, import_jsx_runtime.jsx)("path", { d: "M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10", style: { fill: (props == null ? void 0 : props.fill) ?? "#000000", stroke: "#000000" } }), (0, import_jsx_runtime.jsx)("path", { d: "M 9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z", style: { fill: "#ffffff", stroke: "#ffffff" } }), (0, import_jsx_runtime.jsx)("path", { d: "M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z", transform: "matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)", style: { fill: "#ffffff", stroke: "#ffffff" } }), (0, import_jsx_runtime.jsx)("path", { d: "M 24.55,10.4 L 24.1,11.85 L 24.6,12 C 27.75,13 30.25,14.49 32.5,18.75 C 34.75,23.01 35.75,29.06 35.25,39 L 35.2,39.5 L 37.45,39.5 L 37.5,39 C 38,28.94 36.62,22.15 34.25,17.66 C 31.88,13.17 28.46,11.02 25.06,10.5 L 24.55,10.4 z ", style: { fill: "#ffffff", stroke: "none" } })] }) }),
  bB: (props) => (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "0 0 45 45", width: "100%", height: "100%", style: props == null ? void 0 : props.svgStyle, children: (0, import_jsx_runtime.jsxs)("g", { style: {
    opacity: "1",
    fill: "none",
    fillRule: "evenodd",
    fillOpacity: "1",
...
var defaultArrowOptions = {
  ...
  arrowStartOffset: 0
  // how far from the center of the start square the arrow begins, as a fraction of square width (0 = center, 0.5 = edge). Values between 0.3-0.4 give a chess.com-like look where the arrow starts near the base of the piece. Values above 0.5 will start outside the square.
};
...
function ChessboardProvider({ children, options }) {
  ...
  (0, import_react.useEffect)(() => {
    onArrowsChange == null ? void 0 : onArrowsChange({ arrows: internalArrows });
  }, [internalArrows]);
  ...
  const drawArrow = (0, import_react.useCallback)((newArrowEndSquare, modifiers) => {
    ...
    if (newArrowStartSquare && newArrowStartSquare !== newArrowEndSquare) {
      const arrowColor = (modifiers == null ? void 0 : modifiers.shiftKey) ? arrowOptions.secondaryColor : (modifiers == null ? void 0 : modifiers.ctrlKey) ? arrowOptions.tertiaryColor : arrowOptions.color;
  ...
  const setNewArrowOverSquareWithModifiers = (0, import_react.useCallback)((square, modifiers) => {
    const color = (modifiers == null ? void 0 : modifiers.shiftKey) ? arrowOptions.secondaryColor : (modifiers == null ? void 0 : modifiers.ctrlKey) ? arrowOptions.tertiaryColor : arrowOptions.color;
    if (square) {
  ...
  const handleDragEnd = (0, import_react.useCallback)(function handleDragEnd2(event) {
    ...
    const dropSquare = (_a = event.over) == null ? void 0 : _a.id.toString();
    if (!dropSquare) {
      onPieceDrop == null ? void 0 : onPieceDrop({
        piece: draggingPiece,
    ...
    if (event.over) {
      const isDropValid = onPieceDrop == null ? void 0 : onPieceDrop({
        piece: draggingPiece,
        sourceSquare: draggingPiece.position,
  ...
  const handleDragStart = (0, import_react.useCallback)(
    ...
    function handleDragStart2({ active }) {
      var _a;
      const isSparePiece = (_a = active.data.current) == null ? void 0 : _a.isSparePiece;
      onPieceDrag == null ? void 0 : onPieceDrag({
        isSparePiece,
        piece: isSparePiece ? {
          pieceType: active.id
...
function Arrows() {
  ...
  return (0, import_jsx_runtime.jsx)("svg", { viewBox: `0 0 ${viewBoxWidth} ${viewBoxHeight}`, style: {
    ...
    if (r === Math.hypot(1, 2) * squareWidth) {
      ...
      const start = isVerticalFirst ? { x: from.x, y: from.y + Math.sign(dy) * startOffset } : { x: from.x + Math.sign(dx) * startOffset, y: from.y };
      const corner = isVerticalFirst ? { x: from.x, y: to.y } : { x: to.x, y: from.y };
...
var Piece = (0, import_react.memo)(function Piece2({ clone, isSparePiece = false, position, pieceType }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (positionDifferences[position]) {
      ...
      const squareWidth = (_a = document.querySelector(`#${id}-square-${sourceSquare}`)) == null ? void 0 : _a.getBoundingClientRect().width;
      if (!squareWidth) {
  ...
  return (0, import_jsx_runtime.jsx)("div", { id: `${id}-piece-${pieceType}-${position}`, "data-piece": pieceType, style: {
    ...
    ...!clone && (draggingPiece == null ? void 0 : draggingPiece.position) === position ? { ...defaultDraggingPieceGhostStyle, ...draggingPieceGhostStyle } : {},
    width: "100%",
    height: "100%",
    cursor: cursorStyle,
    touchAction: "none"
    // prevent zooming and scrolling on touch devices
  }, onClick: () => onPieceClick == null ? void 0 : onPieceClick({ isSparePiece, piece: { pieceType }, square: position }), children: (0, import_jsx_runtime.jsx)(PieceSvg, { square: position }) });
});
var Square = (0, import_react.memo)(function Square2({ children, squareId, isLightSquare, isOver }) {
  ...
  (0, import_react.useEffect)(() => {
    if (isOver && draggingPiece) {
      onMouseOverSquare == null ? void 0 : onMouseOverSquare({
        piece: currentPosition[squareId] ?? null,
        square: squareId
      });
    } else if (!isOver && draggingPiece && prevIsOverRef.current) {
      onMouseOutSquare == null ? void 0 : onMouseOutSquare({
        piece: currentPosition[squareId] ?? null,
        square: squareId
      });
    }
  ...
  const column = (_a = squareId.match(/^[a-z]+/)) == null ? void 0 : _a[0];
  const row = (_b = squareId.match(/\d+$/)) == null ? void 0 : _b[0];
  return (0, import_jsx_runtime.jsxs)("div", { id: `${id}-square-${squareId}`, style: {
    ...
    if (e.button === 0) {
      onSquareClick == null ? void 0 : onSquareClick({
        piece: currentPosition[squareId] ?? null,
        square: squareId
      });
    }
    ...
    e.preventDefault();
    if (!isDrawingArrow) {
      onSquareRightClick == null ? void 0 : onSquareRightClick({
        piece: currentPosition[squareId] ?? null,
        square: squareId
      });
    }
    ...
    onSquareMouseDown == null ? void 0 : onSquareMouseDown({
      piece: currentPosition[squareId] ?? null,
      square: squareId
    }, e);
  }, onMouseUp: (e) => {
    ...
    onSquareMouseUp == null ? void 0 : onSquareMouseUp({
      piece: currentPosition[squareId] ?? null,
      square: squareId
    }, e);
  }, onMouseOver: (e) => {
    ...
    ...numericNotationStyle
  }, children: row })] }) : null, (squareRenderer == null ? void 0 : squareRenderer({
    piece: currentPosition[squareId] ?? null,
    square: squareId,
    children
...
function Board() {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsxs)("div", { id: `${id}-board`, style: { ...defaultBoardStyle(chessboardColumns), ...boardStyle }, children: [board.map((row) => row.map((square) => {
    ...
    snapCenterToCursor,
    ...allowDragOffBoard ? [] : [preventDragOffBoard(id, (draggingPiece == null ? void 0 : draggingPiece.position) || "")]
