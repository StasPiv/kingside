...
export const play: AssistantFeature = {
  ...
  highlights: [
    'Time controls: ultra-bullet 15s, bullet (1+0, 1+1, 2+1), blitz (3+0, 3+2, 5+0, 5+3), rapid (10+0, 10+5, 15+10, 30+0), classical (30+20, 60+0), and fully custom (1-180 min main / 0-180 sec increment)',
