...
DVORETSKY_TEMPLATE_SOURCES: List[Tuple[str, str]] = [
    ...
    # Set 3 — content's batch2 (KS-2132 фаза 4-5): новые позиции главы 1
    ...
    # Фаза 5: добавляем тяжёлые фигуры (ферзь, ладья) — на 1.12/1.13
    # без них recognizer выдавал только пешки, теряя ладьи и королей.
    ('diag_1.12.png', '8/8/1p1k4/pR6/PP6/3q4/8/1K6'), # Йейтс — Тартаковер
    ('diag_1.13.png', '8/5p2/3k1p2/5R1p/3K3P/5rP1/8/8'), # Юсупов — Любоевич
]
