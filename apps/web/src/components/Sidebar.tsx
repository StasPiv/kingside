...
const NAV_ITEMS: NavItem[] = [
  ...
  // KS-4646 / KS-4644: «Лекции» — отдельный публичный раздел. Раньше
  // ссылка `/lectures` жила только в выпадающем меню профиля (`MainLayout`)
  // и в drawer'е «Ещё» mobile, доступная только авторизованным. Из-за
  // этого Googlebot не видел `/lectures` ни на одной публичной странице
  // (см. диагностику KS-4644 через GSC API: 0 переходов бота на каталог
  // и ни одной из 16 лекций). Выносим пункт в основную навигацию sidebar
  // (видимую гостям) — между «Уроки» и «Трансляции», семантически
  // соседствует с обучающим/контентным разделом.
  {
    path: '/lectures',
    icon: '🎤',
    i18nKey: 'nav.lectures',
    match: ['/lectures'],
  },
