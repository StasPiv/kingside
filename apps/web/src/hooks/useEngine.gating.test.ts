...
// KS-4735-fix2: track('engine_started') теперь не в useEngine,
// а напрямую в AnalysisPage.toggleAnalysis (onClick Start). Тесты
// на сам track ушли в AnalysisPage.test.tsx, здесь они удалены.
