...
export async function generatePuzzlesFromPgn(
  ...
  // KS-4101: deploy теперь собирает maia-core (turbo) перед vite, entry
  // dist/browser.js доступен. Best-effort: ошибки на отдельных пазлах не
  // валят генерацию (пазл сохранится с null, как раньше).
