...
export async function generatePuzzlesFromPgn(
  ...
  // (annotatePuzzlesWithMaia). Временно отключён: даже после сборки
  // maia-core (KS-4101) vite не резолвит '@kingside/maia-core/browser'
  // — вероятно, subpath ./browser не объявлен/неверен в exports пакета.
  // Подключим обратно после фикса maia-core (backend). Код шага готов в
  // коммите 3883026.
