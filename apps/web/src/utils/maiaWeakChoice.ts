 ...
 *
 * Использует ту же формулу `@kingside/maia-core`, что и сервер — без
 * дублирования (KS-4096 acceptance: «как серверные»). Сведение
 * клиентской копии `apps/web/src/lib/maia/` к `@kingside/maia-core` —
 * отдельная будущая задача (frontend + packages).
 */
import {
