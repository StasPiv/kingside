  ...
  return (
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route path="/puzzle-rush">
          <Route index element={<ProtectedRoute><PuzzleRushPage /></ProtectedRoute>} />
          <Route path="leaderboard" element={<ProtectedRoute><PuzzleRushLeaderboardPage /></ProtectedRoute>} />
        </Route>
