/**
 * KS-2952 / ADR-061 §9.1 (отступление от §9).
 *
 ...
 * (см. историю KS-2952), архитектор зафиксировал отступление в ADR-061
 * §9.1 (commit 170de962). При добавлении новых валидаторов в DTO нужно
